...
func (c *clientStreamingClient) GetServerResponse(ctx context.Context, opts ...grpc.CallOption) (ClientStreaming_GetServerResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &ClientStreaming_ServiceDesc.Streams[0], "/clientstreaming.ClientStreaming/GetServerResponse", opts...)
	if err != nil {
		return nil, err
	}
...
var ClientStreaming_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "clientstreaming/clientstreaming.proto",
}
